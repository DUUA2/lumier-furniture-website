  ...
  private initializeProducts() {
    const sampleProducts: Omit<Product, 'id' | 'createdAt'>[] = [
      ...
      },
      {
        ...
        description: 'Luxurious single seater',
        price: 55000,
        category: 'Living Room',
        image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400',
        colors: ['#7C2D12', '#166534', '#581C87'],
        dimensions: '70cm x 70cm x 85cm',
      ...
      },
      {
        ...
        description: '4-seater with tempered glass top',
        price: 89000,
        category: 'Dining Room',
        image: 'https://images.unsplash.com/photo-1549497538-303791108f95?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400',
      ...
      {
        name: 'Bookshelf Unit',
        description: '5-tier open shelving',
        price: 42000,
        category: 'Storage',
        image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400',
      ...
      {
        name: 'Ergonomic Desk',
        description: 'Height-adjustable workspace',
        price: 75000,
        category: 'Office',
        image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400',
        colors: ['#374151', '#92400E'],
      ...
      },
      {
        ...
        description: 'Round wall mirror with frame',
        price: 12000,
        category: 'Decor',
        image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400',
        colors: ['#92400E', '#374151'],
      ...
      },
      {
        ...
        description: '4-drawer storage solution',
        price: 58000,
        category: 'Bedroom',
        image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400',
        colors: ['#FFFFFF', '#92400E', '#6B7280'],
        dimensions: '80cm x 40cm x 100cm',
        material: 'MDF with Laminate',
        weight: '42kg',
        inStock: true,
        availableForPreOrder: false
      ...
      {
        name: 'Bar Stool Set',
        description: 'Set of 2 adjustable height stools',
        price: 48000,
        category: 'Dining Room',
        image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400',
        colors: ['#000000', '#374151', '#92400E'],
        dimensions: '40cm x 40cm x 75cm each',
