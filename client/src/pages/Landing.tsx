    ...
    <div>
          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-white text-white hover:bg-white hover:text-lumier-black"
              >
                Learn More
              </Button>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="bg-lumier-gold rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
              <Award className="h-8 w-8 text-lumier-black" />
            </div>
            <h3 className="text-xl font-semibold mb-2">Premium Quality</h3>
            <p className="text-lumier-gray">Handpicked luxury furniture from trusted brands</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lumier-gray mb-8 text-lg">
